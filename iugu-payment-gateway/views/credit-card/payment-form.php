		...
		<?php if (isset($order_total)) : ?>
			<p>
				<?php if ($registration_required) { ?>
					<input type="checkbox" id="iugu-save-card" checked hidden placeholder="<?php _e('To save the card you need to create an account.', 'iugu-woocommerce'); ?>" name="iugu_save_card">
				<?php } else { ?>
					<input type="checkbox" id="iugu-save-card" placeholder="<?php _e('To save the card you need to create an account.', 'iugu-woocommerce'); ?>" name="iugu_save_card"> <label for="iugu-save-card"><?php _e('Save this credit card', 'iugu-woocommerce'); ?></label>
				<?php } ?>
			</p>
			<p id="p-iugu-save-default">
				<input type="checkbox" id="iugu-save-default" name="iugu_save_default"> <label for="iugu-save-default"><?php _e('Use with default', 'iugu-woocommerce'); ?></label>
			</p>
		<?php endif; ?>
	</div>
