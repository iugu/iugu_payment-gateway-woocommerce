	...
	<div class="woocommerce-message">
		<span class="woocommerce-table woocommerce-table--order-details shop_table order_details">
			<div class="woocommerce-column woocommerce-column--1">
				<h3 class="woocommerce-column__title"><?php _e('PIX QRCode', 'iugu-woocommerce'); ?></h3>
			...
			<div class="woocommerce-column woocommerce-column--1">
				...
				<button class="iugu-pix-text-button" id="iugu_pix_qrcode_text_button" data-clipboard-text='<?php echo $qrcode_text; ?>'><?php _e('Copy Code', 'iugu-woocommerce'); ?></button><br />
			</div>
		</span>
	</div>
<?php } else { ?>
